...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Patient p0 = new Patient("P0", "PR1", 98);
        Patient p1 = new Patient("P1", "PR2", 38);
        Patient p2 = new Patient("P2", "PR2", 105);
        Patient p3 = new Patient("P3", "PR2", 13);
        Patient p4 = new Patient("P4", "PR2", 5);
        Patient p5 = new Patient("P5", "PR2", 56);
        Patient p6 = new Patient("P6", "PR1", 118);
        Patient p7 = new Patient("P7", "PR2", 24);
        Patient p8 = new Patient("P8", "PR2", 93);
        Patient p9 = new Patient("P9", "PR2", 72);
