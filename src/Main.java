...
////
        ...
        try (Writer writer = new BufferedWriter(new OutputStreamWriter(
            ...
            writer.write(best.toString() + " " + f.fO(best) + " " + (t_1A - t_0A) / pow(10, 9) + " s." + "\r\n");
            writer.write(gene + " " + f.fO(gene)+ " " + (t_1G - t_0G) / pow(10, 9) + " s." + "\r\n");
            writer.write(graspRCL + " " + f.fO(graspRCL)+ " " + (t_1GRCL - t_0GRCL) / pow(10, 9) + " s." + "\r\n");
            writer.write(grasp + " " + f.fO(grasp) + " " + (t_1GR - t_0GR) / pow(10, 9) + " s." + "\r\n");
        } catch (IOException e) {
            e.printStackTrace();
        }
